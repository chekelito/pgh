...
/* Forzar color gris claro a captions, párrafos y cursivas del sistema */
.stCaption, .stMarkdown em, .stMarkdown p {
    color: #9BA8B5 !important;
}

/* Forzar que los labels (títulos) de los inputs siempre sean visibles */
.stNumberInput label, .stTextInput label, .stSelectbox label {
    color: #9BA8B5 !important;
}

/* Asegurar que el texto dentro de la caja de resultado se mantenga legible */
.pgh-result-sub {
    color: #9BA8B5 !important;
}
</style>
