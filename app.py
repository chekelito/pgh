...
with c1:
    ...
    <img src="https://raw.githubusercontent.com/chekelito/pgh/main/LOGO_PGH.png" style="width:42px;height:42px;border-radius:12px;object-fit:contain;background:transparent;padding:2px">
    <div>
